  ...
  return (
    <>
      {canvasStore.layoutEditableVisible && (
        <div className="h-full w-full bg-stone-900/90 aspect-square grid grid-cols-3 grid-rows-3 place-items-center p-4">
          {/* Top */}
          <div
            onClick={() => onSplit("above")}
            className="bg-green-500 rounded-full hover:bg-green-700 cursor-pointer col-start-2 row-start-1 flex items-center justify-center"
          >
          ...
          <div
            ...
            className="bg-green-500 rounded-full hover:bg-green-700 cursor-pointer col-start-2 row-start-3 flex items-center justify-center"
          >
          ...
          <div
            ...
            className="bg-green-500 rounded-full hover:bg-green-700 cursor-pointer col-start-1 row-start-2 flex items-center justify-center"
          >
          ...
          <div
            ...
            className="bg-green-500 rounded-full hover:bg-green-700 cursor-pointer col-start-3 row-start-2 flex items-center justify-center"
          >
          ...
          <div
            onClick={() => onRemove()}
            className="bg-red-500 rounded-full hover:bg-red-700 cursor-pointer col-start-2 row-start-2 flex items-center justify-center"
          >
